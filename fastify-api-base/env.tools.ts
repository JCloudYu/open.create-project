...
export type LogLevels = 'debg'|'info'|'warn'|'eror'|'fatl';
type CodedError = Error & {code?:string;}
interface LogStreamMetaInfo {time_milli:boolean; tags:string[]; accepted_levels:LogLevels[]};
...
const LOG_LEVELS:LogLevels[] = [ 'debg', 'info', 'warn', 'eror', 'fatl' ];
