type SUPPORTED_BASE = 16|32|62;
class BaseConvert {
	#base:SUPPORTED_BASE;
	constructor(base:SUPPORTED_BASE) {
		this.#base = base;
	}
	encode(data:string|Uint8Array):string {
		...
		return BinaryDump(data, this.#base);
	}
	decode(base_str:string):Uint8Array {
		return BinaryFrom(base_str, this.#base);
	}
}

export const Base16 = new BaseConvert(16);
export const Base32 = new BaseConvert(32);
export const Base62 = new BaseConvert(62);
export { Base32 as Base32Hex };
